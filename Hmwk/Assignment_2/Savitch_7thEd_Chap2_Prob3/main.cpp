 ...
 * File:   main.cpp
 * Author: John Decker
 * Purpose: Assignment 2, Savitch 7th Edition, Chapter 2, Problem 3
 * Created on June 30, 2014, 9:08 PM
 */
...
int main()
{
    ...
    const float Mns_retro = 6;
    float prev_yr_salary, retro_pay, new_yr_salary, new_mn_salary;
    char repeat;
